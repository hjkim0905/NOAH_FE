    ...
    return (
        <div className="absolute top-[18px] left-[20px] right-[20px] h-[75px] bg-white rounded-[10px] shadow-[2px_4px_20px_rgba(0,0,0,0.2)] pointer-events-auto">
            ...
            <div className="absolute inset-0 flex justify-center items-center">
                ...
                >
                    Sandae-ri, Angang-eup, Gyeongju-si, Gyeongsangbuk-do
                </div>
            </div>

            <div className="flex justify-between items-start h-full">
                {/* 로고 */}
                <div className="flex items-start pt-[28px] pl-[28px]">
                    <div className="w-[102px] h-[18px]">
                        <Image
                            src="/images/Logo.png"
                            alt="Logo"
                            width={102}
                ...
                {/* 오른쪽 위도/경도 컨테이너들 */}
                <div className="flex gap-[15px] pt-[21px] pr-[28px]">
                    {/* 경도 컨테이너 */}
